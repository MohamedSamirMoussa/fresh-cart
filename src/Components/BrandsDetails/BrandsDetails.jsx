...
const BrandsDetails = () => {
    ...
    const handleBrandsData = async () => {
        return await axios.get(`https://ecommerce.routemisr.com/api/v1/brands/${id}`)
    }

    const {data , isLoading} = useQuery(`brands-details${id}`, handleBrandsData)
    ...
    return (
        <div className="py-10 mt-10 relative">
            <Link to={'/brands'} className="absolute top-15 z-20 end-10 border-1 border-gray-300 rounded-2xl w-[40px] h-[40px] flex justify-center items-center cursor-pointer">
            ...
            <div className="container w-[80%] mx-auto">
                ...
                <div className="inner flex justify-center">
                    <div className="md:w-1/3 p-5 shadow-xl border-1 border-gray-300 rounded-2xl">
                        <img src={x?.image} className='w-full' alt="" />
