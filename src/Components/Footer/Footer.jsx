  ...
  return (
    <div className="bg-[#f0f3f2] py-10">
      <div className="w-[80%] mx-auto py-10">
        ...
        <div className="flex flex-wrap items-center justify-center flex-row border-b border-gray-300 gap-x-2 py-10">
          <div className="w-full md:w-[70%] lg:w-[70%]">
          <input type="email" placeholder="Enter your email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2" />
          </div>
          <div className="md:w-[25%] my-2 md:my-0">
            <button className="bg-[#0aad0a] text-white px-4 py-2 md:px-8 md:py-2 rounded-lg">Share App Link</button>
          </div>
   
        </div>
        <div className="flex flex-wrap items-center space-x-3 py-10 border-b border-gray-300">
