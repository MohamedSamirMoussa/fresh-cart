    ...
    return (
        ...
        <nav className={nav ? "bg-white shadow-xl fixed w-full z-20 top-0 start-0 border-b border-gray-200 py-2 transition-all duration-500"
            ...
            <div className={nav ? "lg:w-[90%] transition-all duration-500 flex flex-wrap items-center justify-between mx-auto p-4"
                : "flex flex-wrap items-center justify-between mx-auto p-4 lg:w-[100%] transition-all duration-500"
            }>
                <Link
                    to={"/"}
                ...
                <div className="flex items-center justify-end md:justify-center w-[45%] md:w-auto lg:order-3">
                    ...
                    {
                        token ? <button onClick={touchBtn} data-collapse-toggle="navbar-sticky" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 " aria-controls="navbar-sticky" aria-expanded="false">
                ...
                <div className={!touched ? "items-center justify-center hidden md:hidden lg:flex w-full lg:w-auto lg:order-2" : "items-center justify-center w-full lg:order-1 lg:flex"} id="navbar-sticky">
